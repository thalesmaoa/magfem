...
const PT: Translations = {
  ...
  about: {
    ...
    triangle: 'Tangle (David Meeker) — gerador de malha do FEMM, licença MIT',
  ...
  msg: {
    ...
    orientationRemoved: (n) => `${n} restrição(ões) horizontal/vertical removida(s): deixariam de valer depois de mover/girar.`,
...
Atribuição: l = g.line((0, 0), (10, 0)) e depois use l. Setas ↑/↓ = comandos anteriores.`,
  ...
  mesh: {
    ...
    nodeHint: 'Defina antes materiais e contornos; ▶ gera a malha (Tangle).',
    ...
    mesher: 'Gerador: Tangle (David Meeker, o do FEMM), Delaunay com qualidade e periódicos casados.',
...
const EN: Translations = {
  ...
  about: {
    ...
    triangle: 'Tangle (David Meeker) — the FEMM mesh generator, MIT License',
  ...
  msg: {
    ...
    orientationRemoved: (n) => `${n} horizontal/vertical constraint(s) removed: they would no longer hold after the move/rotation.`,
...
Assignment: l = g.line((0, 0), (10, 0)) then use l. Up/Down arrows = previous commands.`,
  ...
  mesh: {
    ...
    nodeHint: 'Set materials and boundaries first; ▶ generates the mesh (Tangle).',
    ...
    mesher: 'Mesher: Tangle (David Meeker, the FEMM mesher), quality Delaunay with matched periodic boundaries.',
